...
const nextConfig = {
  ...
  eslint: {
    ignoreDuringBuilds: true,   // ← ne bloque pas le build sur les erreurs ESLint (guillemets hébreu, etc.)
  },
  images: {
    ...
    remotePatterns: [
      ...
      { protocol: 'https', hostname: 'images.tataphone.co.il' },  // domaine custom R2 (futur)
