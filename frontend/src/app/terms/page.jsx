...
import sections from '@/data/terms.json'

export const metadata = {
  title: 'תנאי שימוש',
  description: 'תנאי השימוש של טאטעפון — מוצרים, מחירים, משלוח, ביטול והחזרות.',
}
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="flex items-center gap-3 mb-8">
        <div className="w-12 h-12 rounded-2xl bg-primary-50 flex items-center justify-center"><Shield className="w-6 h-6 text-primary-600" /></div>
        <div>
          <h1 className="text-3xl font-black text-slate-900">תנאי שימוש</h1>
